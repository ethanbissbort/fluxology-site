...
1. Never discard purchased, expired, inactive or historical records merely because they are no longer live. The archive remains the lossless fallback for the pre-rebuild state.
